...
const INITIAL_REPLIES = ["📦 Envíos", "↩️ Devoluciones", "🎮 Productos", "💳 Pagos", "🛒 Vender"];
...
const ConsoleIcon = ({ size = 40, wink = false, small = false }) => {
  ...
  return (
    <svg width={size} height={h} viewBox="0 0 64 80" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Cuerpo */}
      <rect x="1" y="1" width="62" height="78" rx="8" fill="#4c1d95"
        stroke="rgba(255,255,255,0.2)" strokeWidth="2" />
      <rect x="1" y="1" width="62" height="78" rx="8" fill="none"
        stroke="rgba(0,0,0,0.35)" strokeWidth="4" />

      {/* Pantalla */}
      <rect x="8" y="8" width="48" height="30" rx="3" fill="#8b9331"
      ...
      <ellipse cx="26" cy="21" rx="3.5" ry="3.5" fill="#000"
        style={{
          ...
          transition: wink ? "transform 0.12s ease-in-out" : "transform 0.12s ease-in-out",
        }}
      />
      ...
      {!wink ? (
        ...
        <path d="M 22 28 Q 32 34 42 28" stroke="rgba(0,0,0,0.7)" strokeWidth="2"
    ...
    >
      ...
      <div className="fab-wrap">
        ...
        >
          {open
            ? <CloseIcon />
            : <ConsoleIcon size={52} wink={winking} />
          }
          {hasUnread && !open && (
...
const styles = {
  panel:           { position:"fixed", bottom:"110px", right:"24px", width:"360px", maxHeight:"540px", background:"#ffffff", borderRadius:"20px", boxShadow:"0 8px 40px rgba(0,0,0,0.14)", display:"flex", flexDirection:"column", overflow:"hidden", zIndex:9999, animation:"fadeSlideUp .25s ease", fontFamily:"'DM Sans',system-ui,sans-serif" },
