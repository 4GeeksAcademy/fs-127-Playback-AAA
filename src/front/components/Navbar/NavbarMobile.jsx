...
export const NavbarMobileActions = ({
  ...
  langRefMobile, langOpen, setLangOpen,
  handleSelectLanguage, currentLang,
}) => (
  <div className="flex md:hidden items-center gap-2 flex-shrink-0">
    <button
      onClick={() => setMobileOpen(!mobileOpen)}
      className="w-9 h-9 flex items-center justify-center rounded-xl border border-theme-border bg-theme-input transition"
      aria-label="Menú"
    >
      <UserRound
