    ...
    if (loading) return (
        <section className="mt-8">
            <div className="flex items-center justify-between my-4">
                <h2 className="text-lg font-semibold tracking-tight text-theme-text">Top Ventas</h2>
            </div>
            ...
            <div className="overflow-hidden">
                <div ref={carouselRef} className="flex gap-3 overflow-x-hidden">
                    {products.map((p) => (
                        <div
                            key={p.id}
                            className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 flex-none border border-theme-border bg-theme-bg overflow-hidden group cursor-pointer hover:shadow-lg transition-all duration-200"
                        >
