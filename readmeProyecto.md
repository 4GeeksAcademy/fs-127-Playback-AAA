## 🌱 Poblar la base de datos (Seed de Categorías)

Para cargar automáticamente las categorías, subcategorías e ítems en la base de datos, ejecuta el siguiente comando desde la raíz del proyecto:
